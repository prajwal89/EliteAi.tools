...
class ToolSocialHandlesDTO
{
    public function __construct(
        ...
        public ?string $youtubeHandleId = null,
        public ?string $pinterestUserId = null,
        public ?string $slackAppId = null,
        public ?string $slackChannelId = null,
        public ?string $figmaPluginId = null,
    ...
    public static function fromArray(array $array): self
    {
        return new ToolSocialHandlesDTO(
            ...
            youtubeHandleId: $array['youtube_handle_id'] ?? null,
            pinterestUserId: $array['pinterest'] ?? null,
            slackAppId: $array['slack_app_id'] ?? null,
            slackChannelId: $array['slack_channel_id'] ?? null,
            figmaPluginId: $array['figma_plugin_id'] ?? null,
    ...
    public static function fromJson(string $json): self
    {
        ...
        return new ToolSocialHandlesDTO(
            ...
            youtubeHandleId: $data['youtubeHandleId'] ?? null,
            pinterestUserId: $data['pinterestUserId'] ?? null,
            slackAppId: $data['slackAppId'] ?? null,
            slackChannelId: $data['slackChannelId'] ?? null,
            figmaPluginId: $data['figmaPluginId'] ?? null,
