        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.tools.update', ['tool' => $tool->id]) }}"
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea type="text" id="description" class="form-control" rows="10" name="description">{{ $tool->description ?? '' }}</textarea>
                </div>
                ...
                <div class="border p-2 my-4">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" placeholder="100084529884548" class="form-control" name="facebook_id"
                            value="{{ $tool->facebook_id }}" />
                    </div>
                    <div class="form-group mb-4">
                        <label class="fw-bold">youtube_channel_id</label>
                        <input type="text" placeholder="UCFO-zeRBQpoKecuOYyG4Mcw" class="form-control"
                            name="youtube_channel_id" value="{{ $tool->youtube_channel_id }}">
                    </div>
                </div>
