<div class="tab-pane fade" id="social-media" role="tabpanel">
    <div class="border p-2 my-4">
        ...
        <div class="form-group mb-4">
            ...
            <input type="text" placeholder="prajwal_hallae" value="{{ $tool->twitter_id ?? '' }}" class="form-control"
                name="twitter_id">
        </div>
        <div class="form-group mb-4">
        ...
        <div class="form-group mb-4">
            ...
            <input type="text" placeholder="prajwal_hallae" value="{{ $tool->tiktok_id ?? '' }}" class="form-control"
                name="tiktok_id">
        </div>
        <div class="form-group mb-4">
