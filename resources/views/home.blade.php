        ...
        <ul class="grid gap-8 md:grid-cols-2 lg:grid-cols-3 p-2 xl:p-5">
            @foreach ($tools as $tool)
                <li
                    ...
                    <a class="" href="https://tailwindflex.com/mereani/hero-section-with-big-heading">
                    ...
                    <div class="flex flex-col justify-beetween gap-3 px-4 py-3">
                        <a href="https://tailwindflex.com/mereani/hero-section-with-big-heading"
                        ...
                        <ul class="flex flex-wrap justify-start my-1 text-xs gap-2">
                            <li class="flex gap-0.5 bg-gray-600 text-white px-2 py-0.5 rounded-full">
                                <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <a href="">{{ $tool->pricing_type }}</a>
                            </li>
                        </ul>
